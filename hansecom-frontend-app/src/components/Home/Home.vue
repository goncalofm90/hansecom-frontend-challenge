...
<template>
  <section
    class="relative z-20 overflow-hidden dark:bg-dark pt-20 pb-12 lg:pt-[120px] lg:pb-[90px]"
  >
      ...
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4">
          <div class="mx-auto mb-[60px] max-w-[520px] text-center lg:mb-20">
            ...
            <h2 class="mb-4 text-3xl font-bold text-dark sm:text-[40px] sm:leading-[48px]">
        ...
        <div class="w-full px-4 lg:w-1/2">
          <template :key="faq.id" v-for="faq in evenFaqs">
            ...
            >
              <button class="faq-btn flex w-full text-left" @click="handleToggle(faq.id)">
                <div
                  class="mr-5 flex h-10 w-full max-w-[40px] items-center justify-center rounded-lg bg-primary/5 text-primary/5"
                >
                  <svg
                    class="fill-primary stroke-primary duration-200 ease-in-out"
                    :class="{ 'rotate-180': activeFaq === faq.id }"
      ...
      >
        ...
        <defs>
          ...
          >
            ...
            <stop offset="1" stop-color="#5552FD" stop-opacity="0" />
            <stop offset="1" stop-color="#C2AD" stop-opacity="0.096144" />
          </linearGradient>
        </defs>
      </svg>
    </div>
